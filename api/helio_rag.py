...
from heliosrag.api.helio_database import get_database
from heliosrag.api.helio_llm import LLM
from heliosrag.api.helio_paraphraser import PARAPHRASER
from heliosrag.api.interfaces.helio_ragmodelexpanded import (
    QuestionAnsweringWithQueryExpansion,
)
from heliosrag.helio_paths import USER_VECTORSTORES_DIR
...
def get_user_rag_model(user_id: Optional[str] = None) -> QuestionAnsweringWithQueryExpansion:
    ...
    if user_id:
        ...
        user_vectorstore_path = USER_VECTORSTORES_DIR / user_id
